      ...
      <form onSubmit={onSubmit}
        ...
        <input
          ...
          style={{
            ...
            border: "1px solid #d1d5db", marginBottom: 16, fontSize: 16
          }}
        />

        <label style={{ display: "block", fontWeight: 600, marginBottom: 8 }}>Passcode</label>
        <input
          type="password"
          value={code}
          ...
          style={{
            width: "100%", padding: "12px 14px", borderRadius: 10,
            border: "1px solid #d1d5db", marginBottom: 12, fontSize: 16
          }}
        />
        ...
        {error && (
          <div style={{
            ...
            padding: "10px 12px", borderRadius: 10, marginBottom: 12, fontSize: 14
          }}>
            {error}
          </div>
        )}
        ...
        <button
          ...
          style={{
            width: "100%", padding: "12px 14px", borderRadius: 10,
            border: "1px solid #111827", fontSize: 16, fontWeight: 700,
        ...
        <p style={{ color: "#6b7280", fontSize: 14, marginTop: 14 }}>
          Having trouble? Double-check your e-mail and password. Contact the organizer if needed.
        </p>
      </form>
    </main>
  );
